...
/***/ function(module, exports, __webpack_require__) {
	...
	var Input = function (_React$Component) {
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          "div",
	          { className: "col-md-5 text-box" },
	          _react2.default.createElement("textarea", { className: "form-control", rows: "25",
	            value: this.state.initial,
	            onChange: function onChange(event) {
	              return _this2.onStateChange(event.target.value);
	            } })
	        ),
	        _react2.default.createElement("div", { className: "col-md-7 output-text", dangerouslySetInnerHTML: { __html: this.state.output } })
	      );
	    } //End render
	  ...
	  return Input;
	}(_react2.default.Component); //End Input class
	
	//Render the input component to the div class "app"
	
	
	_reactDom2.default.render(_react2.default.createElement(Input, null), document.querySelector(".app"));
